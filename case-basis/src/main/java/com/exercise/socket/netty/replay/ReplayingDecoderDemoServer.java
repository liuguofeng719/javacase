...
public class ReplayingDecoderDemoServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new ReplayingDecoderDemoServer().bind(port);
    }
    ...
    public void bind(int port) throws Exception {
        ...
        try {
            ...
            System.out.println(
                    ReplayingDecoderDemoServer.class.getName() + " 启动成功，在地址[" + f.channel().localAddress() + "]上等待客户请求......");
    ...
    private class ChildChannelHandler extends ChannelInitializer<SocketChannel> {
        ...
        protected void initChannel(SocketChannel ch) throws Exception {
            ...
            pipeline.addLast(new ReplayingDecoderDemoServerHandler());
        }
    }
}
